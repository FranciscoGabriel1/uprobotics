    ...
    <>
      ...
      <Introduction>
        ...
        <p>
          ...
          aqui no Up utilizamos o Webots para desplugada e Arduino caso você
        ...
        <Row className="justify-content-md-center">
          ...
          <Col xl={4}>
            <CardUp
              ...
              title="Thymio II"
              text="Thymio II é um robô educacional acessível. Ele oferece três características principais: um grande número de sensores e atuadores, uma interatividade educativa baseada em luz e toque e um ambiente de programação com programação gráfica e de texto."
            />
          </Col>
          ...
          <Col xl={4}>
            <CardUp
              ...
              title="Pioner 3DX"
              text="Veículo terrestre não tripulado (VTNT) da empresa Adept MobileRobots. O NERO possui 3 exemplares com dimensão de 52x38x21,5 cm. São equipados com sonares e encoders, possibilitando, por exemplo, o mapeamento de um ambiente desconhecido."
            />
          </Col>
